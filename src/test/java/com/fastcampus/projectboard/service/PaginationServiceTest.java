...
class PaginationServiceTest {
    ...
    public void PaginationBarNumbersTest(int currentPageNumber, int totalPages, List<Integer> expected) {
        // given
    ...
    static Stream<Arguments> PaginationBarNumbersTest() {
        return Stream.of(
    ...
    @Test
    public void PaginationBarLengthTest() {
        // given
